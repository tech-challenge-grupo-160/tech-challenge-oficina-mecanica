...
public sealed class EntregarOrdemDeServicoCommandValidator : AbstractValidator<EntregarOrdemDeServicoCommand>
{
    public EntregarOrdemDeServicoCommandValidator()
    {
