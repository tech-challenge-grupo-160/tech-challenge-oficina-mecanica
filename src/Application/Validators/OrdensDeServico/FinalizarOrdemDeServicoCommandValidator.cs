...
public sealed class FinalizarOrdemDeServicoCommandValidator : AbstractValidator<FinalizarOrdemDeServicoCommand>
{
    public FinalizarOrdemDeServicoCommandValidator()
    {
